...
election_data = Path(__file__).parent /"Resources"/ "election_data.csv" # Input file path
file_to_output = Path(__file__).parent /"analysis"/"electionResults.txt"  # Output file path
